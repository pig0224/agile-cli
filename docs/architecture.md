...
├── .gitignore              # 忽略 .worktrees/、.tmp-*/、process-docs/*/assets/ 与 */scripts/（截图与一次性脚本本机留存）；tech-specs/、biz-tech-docs/ 登记为外部仓库后写入（sync 自动补写）
...
agile init workspace --name e2e --tech-specs <src.git>    # settings.json + CLAUDE.md 导航地图 + .gitignore（.worktrees/、.tmp-*/、process-docs/*/assets/ 与 */scripts/、已登记的 tech-specs/）
